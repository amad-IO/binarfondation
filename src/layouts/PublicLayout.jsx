...
const PublicLayout = () => {
    ...
    return (
        <div className="min-h-screen w-full bg-transparent font-sans text-slate-900 selection:bg-blue-100 selection:text-blue-900 relative isolate overflow-x-hidden">
