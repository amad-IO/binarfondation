  ...
  return (
    <section id="edukasi" className="w-full mt-12 lg:mt-20">
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div className="xl:col-span-2 bg-white rounded-[2rem] p-6 lg:p-8 shadow-sm border border-slate-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="group cursor-pointer">
              <div className="w-full aspect-[16/10] bg-slate-200 rounded-2xl mb-4 overflow-hidden flex items-center justify-center text-slate-400 text-sm">
                [Gambar Kosong]
              </div>
              <span className="inline-block bg-blue-100 text-blue-600 text-[10px] font-bold px-3 py-1 rounded-full mb-3">Self Love</span>
            ...
            <div className="group cursor-pointer">
              ...
              <span className="inline-block bg-blue-100 text-blue-600 text-[10px] font-bold px-3 py-1 rounded-full mb-3">Mental Health</span>
              <h4 className="font-bold text-slate-800 mb-2 leading-snug group-hover:text-blue-600 transition-colors">
            ...
            <div className="group cursor-pointer">
              ...
              <span className="inline-block bg-blue-100 text-blue-600 text-[10px] font-bold px-3 py-1 rounded-full mb-3">Remaja</span>
              <h4 className="font-bold text-slate-800 mb-2 leading-snug group-hover:text-blue-600 transition-colors">
        ...
        <div id="relawan" className="xl:col-span-1 bg-[#F4F8FF] rounded-[2rem] p-6 lg:p-8 flex flex-col justify-between relative overflow-hidden shadow-sm border border-blue-50/50">
