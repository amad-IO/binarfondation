                ...
                <div className="flex flex-col lg:flex-row justify-between gap-10 lg:gap-8 xl:gap-10">
                    ...
                    <div className="flex-1 grid grid-cols-2 xl:grid-cols-4 gap-8 gap-y-10 pt-2 w-full">
                        ...
                        <div className="col-span-1">
                            ...
                            <ul className="flex flex-row flex-wrap gap-2 sm:gap-3 lg:flex-col lg:space-y-4 lg:gap-0">
                                {/* Email */}
                                <li>
                                    <a href="mailto:binarfoundation1@gmail.com" className="flex items-center gap-3 text-[16px] font-medium text-slate-500 hover:text-blue-600 transition-colors duration-200 group">
                                        <span className="flex-shrink-0 w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 rounded-full bg-blue-50 group-hover:bg-blue-600 flex items-center justify-center text-blue-600 group-hover:text-white transition-all duration-300 icon-bounce shadow-sm">
                                ...
                                {/* Instagram */}
                                <li>
                                    <a href="https://instagram.com/binar.community" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="flex items-center gap-3 text-[16px] font-medium text-slate-500 hover:text-blue-600 transition-colors duration-200 group">
                                        <span className="flex-shrink-0 w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 rounded-full bg-blue-50 group-hover:bg-[#E1306C] flex items-center justify-center text-blue-600 group-hover:text-white transition-all duration-300 icon-bounce shadow-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 lg:w-5 lg:h-5" viewBox="0 0 24 24" fill="currentColor" stroke="none">
                                ...
                                {/* TikTok */}
                                <li>
                                    <a href="https://www.tiktok.com/@binar.community" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="flex items-center gap-3 text-[16px] font-medium text-slate-500 hover:text-blue-600 transition-colors duration-200 group">
                                        <span className="flex-shrink-0 w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 rounded-full bg-blue-50 group-hover:bg-[#000000] flex items-center justify-center text-blue-600 group-hover:text-white transition-all duration-300 icon-bounce shadow-sm">
                                ...
                                {/* YouTube */}
                                <li>
                                    <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="flex items-center gap-3 text-[16px] font-medium text-slate-500 hover:text-blue-600 transition-colors duration-200 group">
                                        <span className="flex-shrink-0 w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 rounded-full bg-blue-50 group-hover:bg-[#FF0000] flex items-center justify-center text-blue-600 group-hover:text-white transition-all duration-300 icon-bounce shadow-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 lg:w-5 lg:h-5" viewBox="0 0 24 24" fill="currentColor">
