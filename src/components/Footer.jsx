                            ...
                            <ul className="space-y-4">
                                ...
                                <li>
                                    <a href="mailto:binarfoundation1@gmail.com" className="flex items-center gap-3 text-[16px] font-medium text-slate-500 hover:text-blue-600 transition-colors duration-200 group">
                                        <span className="flex-shrink-0 w-10 h-10 rounded-full bg-blue-50 group-hover:bg-blue-600 flex items-center justify-center text-blue-600 group-hover:text-white transition-all duration-300 icon-bounce shadow-sm">
                                ...
                                <li>
                                    <a href="https://instagram.com/binar.community" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-[16px] font-medium text-slate-500 hover:text-blue-600 transition-colors duration-200 group">
                                        <span className="flex-shrink-0 w-10 h-10 rounded-full bg-blue-50 group-hover:bg-[#E1306C] flex items-center justify-center text-blue-600 group-hover:text-white transition-all duration-300 icon-bounce shadow-sm">
                                ...
                                <li>
                                    <a href="https://www.tiktok.com/@binar.community" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-[16px] font-medium text-slate-500 hover:text-blue-600 transition-colors duration-200 group">
                                        <span className="flex-shrink-0 w-10 h-10 rounded-full bg-blue-50 group-hover:bg-[#000000] flex items-center justify-center text-blue-600 group-hover:text-white transition-all duration-300 icon-bounce shadow-sm">
                                ...
                                <li>
                                    <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-[16px] font-medium text-slate-500 hover:text-blue-600 transition-colors duration-200 group">
                                        <span className="flex-shrink-0 w-10 h-10 rounded-full bg-blue-50 group-hover:bg-[#FF0000] flex items-center justify-center text-blue-600 group-hover:text-white transition-all duration-300 icon-bounce shadow-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
