  ...
  return (
    <section id="tentang-kami" className="w-full pt-12 lg:pt-4 pb-12 lg:pb-20">
      ...
      <motion.div 
        ...
        className="bg-[#F4F7FC] rounded-[2rem] p-8 md:p-10 lg:p-12 shadow-sm border border-slate-50"
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 xl:gap-12">
          
          {/* Tentang Kami */}
          <div className="flex flex-col p-4 sm:p-6 rounded-3xl transition-all duration-300 ease-in-out hover:bg-white hover:shadow-xl hover:shadow-blue-900/5 hover:-translate-y-2 border border-transparent hover:border-slate-100 group">
