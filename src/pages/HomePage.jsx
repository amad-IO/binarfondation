        ...
        <>
            ...
            <section className="w-full py-14 lg:py-20 bg-white">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col gap-3 mb-8 lg:mb-10 max-w-2xl">
                        ...
                        <h2 className="text-2xl sm:text-3xl lg:text-[2.5rem] font-bold tracking-tight text-slate-900">
                        ...
                        {quickLinks.map((item) => {
                            ...
                            return (
                                <Link
                                    key={item.to}
                                    to={item.to}
                                    className="group flex flex-col gap-4 rounded-2xl border border-slate-100 bg-white p-5 lg:p-6 min-h-[160px] transition-all duration-200 hover:-translate-y-1 hover:border-slate-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
                                >
